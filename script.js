...
window.addEventListener("DOMContentLoaded", () => {
  ...
  supabase = window.supabase.createClient(
    ...
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlnYW5zenF0Y2tpeHhyc3R1dmFkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg2NjA0MjYsImV4cCI6MjA5NDIzNjQyNn0.Svgyw3nqvKBAYWSI5hIFsM0z3GW-KUiC6xLTuWRCQ7A"
  );
});
...
const translations = {
  ...
  es: {
    nav_login: 'Iniciar Sesión', nav_register: 'Comenzar',
    hero_badge: 'Con la confianza de más de 50,000 inversores',
    hero_title_1: 'Plataforma Digital', hero_title_2: 'de Activos Avanzada',
    hero_subtitle: 'Gestiona y monitorea tu actividad financiera digital de forma segura con herramientas de nivel institucional.',
    hero_cta_1: 'Comenzar', hero_cta_2: 'Iniciar Sesión',
    stat_users: 'Usuarios Activos', stat_volume: 'Volumen de Trading', stat_uptime: 'Tiempo Activo',
    hiw_title: 'Cómo Funciona', hiw_subtitle: 'Comienza tu viaje de inversión en cuatro simples pasos',
    tiers_title: 'Elige Tu Plan de Inversión', tiers_subtitle: 'Planes flexibles diseñados para cada nivel de inversor',
    tier_starter: 'Inicial', tier_basic: 'Básico', tier_standard: 'Estándar', tier_premium: 'Premium',
    tier_daily_roi: 'ROI Diario', tier_popular: 'Más Popular', tier_get_started: 'Comenzar',
    calc_title: 'Calculadora de Inversión', calc_button: 'Calcular Retornos',
    calc_daily: 'Retorno Diario', calc_weekly: 'Retorno Semanal', calc_monthly: 'Retorno Mensual', calc_total: 'Total (30 días)',
    feat_title: 'Características de la Plataforma',
    trust_subtitle: 'Establecido 2008 — Plataforma Registrada de Activos Digitales',
    test_title: 'Lo Que Dicen Nuestros Inversores',
    faq_title: 'Preguntas Frecuentes',
    cta_title: '¿Listo para Invertir?', cta_button: 'Crear Cuenta Gratis',
    login_title: 'Bienvenido', login_button: 'Iniciar Sesión',
    register_title: 'Crear Cuenta', register_button: 'Crear Cuenta'
  },
  fr: {
    nav_login: 'Connexion', nav_register: 'Commencer',
    hero_badge: 'La confiance de plus de 50 000 investisseurs',
    hero_title_1: 'Plateforme Digitale', hero_title_2: "d'Actifs Avancée",
    hero_subtitle: 'Gerez et surveillez votre activité financière numérique en toute sécurité.',
    hero_cta_1: 'Commencer', hero_cta_2: 'Connexion',
    stat_users: 'Utilisateurs Actifs', stat_volume: 'Volume de Trading', stat_uptime: 'Disponibilité',
    hiw_title: 'Comment Ça Marche', tiers_title: 'Choisissez Votre Plan',
    tier_starter: 'Débutant', tier_basic: 'Basique', tier_standard: 'Standard', tier_premium: 'Premium',
    tier_daily_roi: 'ROI Quotidien', tier_popular: 'Plus Populaire', tier_get_started: 'Commencer',
    calc_title: 'Calculateur d\'Investissement', calc_button: 'Calculer les Retours',
    calc_daily: 'Retour Quotidien', calc_weekly: 'Retour Hebdomadaire', calc_monthly: 'Retour Mensuel', calc_total: 'Total (30 jours)',
    feat_title: 'Fonctionnalités', trust_subtitle: 'Établi 2008 — Plateforme Enregistrée',
    test_title: 'Ce Que Disent Nos Investisseurs',
    faq_title: 'Questions Fréquentes',
    cta_title: 'Prêt à Investir?', cta_button: 'Créer un Compte Gratuit',
    login_title: 'Bienvenue', login_button: 'Se Connecter',
    register_title: 'Créer un Compte', register_button: 'Créer un Compte'
  },
  de: {
    nav_login: 'Anmelden', nav_register: 'Loslegen',
    hero_title_1: 'Fortschrittliche Digitale', hero_title_2: 'Asset-Plattform',
    hero_subtitle: 'Verwalten und überwachung Sie Ihre digitalen Finanzaktivitäten sicher.',
    hiw_title: 'So Funktioniert Es', tiers_title: 'Wählen Sie Ihren Plan',
    tier_starter: 'Starter', tier_basic: 'Basis', tier_standard: 'Standard', tier_premium: 'Premium',
    tier_daily_roi: 'Täglicher ROI', tier_popular: 'Beliebteste',
    calc_title: 'Investitionsrechner', calc_button: 'Rendite Berechnen',
    feat_title: 'Plattform-Funktionen',
    test_title: 'Was Unsere Investoren Sagen',
    faq_title: 'Häufige Fragen',
    cta_title: 'Bereit zu Investieren?', cta_button: 'Kostenloses Konto Erstellen',
    login_title: 'Willkommen Zurück', login_button: 'Anmelden',
    register_title: 'Konto Erstellen', register_button: 'Konto Erstellen'
  },
  pt: {
    nav_login: 'Entrar', nav_register: 'Começar',
    hero_title_1: 'Plataforma Digital', hero_title_2: 'de Ativos Avançada',
    hero_subtitle: 'Gerencie e monitore sua atividade financeira digital com segurança.',
    hiw_title: 'Como Funciona', tiers_title: 'Escolha Seu Plano',
    tier_starter: 'Iniciante', tier_basic: 'Básico', tier_standard: 'Padrão', tier_premium: 'Premium',
    tier_daily_roi: 'ROI Diário', tier_popular: 'Mais Popular',
    calc_title: 'Calculadora de Inversimento', calc_button: 'Calcular Retornos',
    feat_title: 'Recursos da Plataforma',
    test_title: 'O Que Nossos Investidores Dizem',
    faq_title: 'Perguntas Frequentes',
    cta_title: 'Pronto para Investir?', cta_button: 'Criar Conta Grátis',
    login_title: 'Bem-vindo', login_button: 'Entrar',
    register_title: 'Criar Conta', register_button: 'Criar Conta'
  },
  ar: {
    nav_login: 'تسجيل الدخول', nav_register: 'ابدأ الآن',
    hero_title_1: 'منصة الأصول الرقمية', hero_title_2: 'المتقدمة',
    hero_subtitle: 'إدارة ومراقبة نشاطك المالي الرقمي بأمان.',
    hiw_title: 'كيف يعمل', tiers_title: 'اختر خطتك',
    tier_starter: 'مبتدئ', tier_basic: 'أساسي', tier_standard: 'قياسي', tier_premium: 'مميز',
    tier_daily_roi: 'العائد اليومي', tier_popular: 'الأكثر شعبية',
    calc_title: 'حاسبة الاستثمار', calc_button: 'حساب العوائد',
    feat_title: 'ميزات المنصة',
    test_title: 'ماذا يقول مستثمرونا',
    faq_title: 'الأسئلة الشائعة',
    cta_title: 'مستعد للاستثمار؟', cta_button: 'إنشاء حساب مجاني',
    login_title: 'مرحبًا بعودتك', login_button: 'تسجيل الدخول',
    register_title: 'إنشاء حساب', register_button: 'إنشاء حساب'
  }
};
...
if (calcBtn) {
  function calculateReturns() {
    ...
    document.getElementById('dailyReturn').textContent = '$' + daily.toFixed(2);
    document.getElementById('weeklyReturn').textContent = '$' + weekly.toFixed(2);
    document.getElementById('monthlyReturn').textContent = '$' + monthly.toFixed(2);
...
async function loadDashboardData() {
  ...
  try {
    ...
    if (user.email) {
      ...
      const profileRes = await fetch(REST_BASE + '/profiles?id=eq.' + user.id, {
      ...
      const txRes = await fetch(REST_BASE + '/transactions?user_id=eq.' + user.id + '&order=created_at.desc&limit=10', {
        headers: { 'apikey': ANON_KEY }
      });
...
async function loadAdminData() {
  try {
    // 1. Instantly check who is trying to access the page
    const { data: { user }, error: authError } = await supabase.auth.getUser();

    // 2. If they aren't logged in, or their email isn't your admin email, block them!
    if (authError || !user || user.email !== 'tylerowennn1@gmail.com') {
      alert("Access Denied: Administrative privileges required.");
      window.location.href = "dashboard.html"; // Kicks them back to the normal user view
      return;
    }

    // 3. If they are the verified admin, safely pull all transactions from the database
    ...
    if (adminBody) {
      ...
      allTransactions.forEach(tx => {
        ...
        row.innerHTML = `
          ...
          <td>${new Date(tx.created_at).toLocaleDateString()}</td>
          <td>
            <button class="btn btn--small" onclick="updateStatus('${tx.id}', 'approved')">Approve</button>
            <button class="btn btn--small btn--danger" onclick="updateStatus('${tx.id}', 'rejected')">Reject</button>
          </td>
        `;
...
async function updateTransactionStatus(txId, status) {
  try {
    await fetch(REST_BASE + '/transactions?id=eq.' + txId, {
      method: 'PATCH',
      headers: {
        'apikey': ANON_KEY,
...
if (depositForm) {
  depositForm.addEventListener('submit', async (e) => {
    ...
    try {
      const userRes = await fetch(AUTH_BASE + '/me', {
        headers: { 'Authorization': 'Bearer ' + token }
      });
      const user = await userRes.json();

      await fetch(REST_BASE + '/transactions', {
        method: 'POST',
        headers: {
          'apikey': ANON_KEY,
          'Content-Type': 'application/json',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (path.includes('dashboard.html') || path.includes('deposit.html') || path.includes('withdraw.html') || path.includes('settings.html')) {
    loadDashboardData();
  }
